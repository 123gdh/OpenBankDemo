...
public interface OpenBankBatchTransferMapper {
    ...
    public void insertOpenBankBatchTransfer(OpenBankBatchTransferDao openBankBatchTransferDao);
    ...
    public OpenBankBatchTransferDao queryOpenBankBatchTransferDao(String out_batch_transfer_id);
    ...
    public void updateStatusByOutId(String batch_transfer_status,String out_batch_transfer_id);
    ...
    public void updateBatchTransferId(String batch_transfer_id,String out_batch_transfer_id);
}
