...
public interface GoProductMapper {
    ...
    public ProductOpenDao queryProduct(String unified_social_credit_code,String product_name);
    ...
    public ProductOpenDao queryByOutRequestNo(String out_request_no);
    ...
    public void updateStateByUnifiedPname(String status,String unified_social_credit_code,String product_name);
    ...
    public void updateStateAndRequestNoByUnifiedPname(String status,String request_no,String unified_social_credit_code,String product_name);

    @Update("update product set status = #{status} where out_request_no = #{out_request_no}")
    public void updateStateByOutRequestNo(String status,String out_request_no);
}
