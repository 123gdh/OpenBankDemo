...
public interface PayerMapper {
    ...
    public PayerDao queryEntIdByOutTransferId(String out_transfer_id);
    ...
    public PayerDao queryEntIdByOutBatchTransferId(String out_batch_transfer_id);
}
