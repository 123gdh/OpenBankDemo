...
public interface OpenBankTransferMapper {
    ...
    OpenBankTransferDao queryByOutId(String out_transfer_id);
    ...
    void insertOpenBankTransfer(OpenBankTransferDao openBankTransferDao);

    @Update("update open_bank_transfer set transfer_status = #{transfer_status} where out_transfer_id = #{out_transfer_id}")
    void updateStatusByOutId(String transfer_status,String out_transfer_id);
}
