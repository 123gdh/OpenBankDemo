...
public interface TransfersMapper {
    ...
    void insertTransfers(TransfersDao transfersDao);
    ...
    List<TransfersDao> queryByTransferId(String transfer_id);


    @Select("update transfers set transfer_status = #{transfer_status} where out_transfer_detail_id = #{out_transfer_detail_id}")
    void updateTransfersStatus(String transfer_status, String out_transfer_detail_id);
}
