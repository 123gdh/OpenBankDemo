...
public class GoProduct {
    ...
    public static ConcurrentHashMap<String, RequestOptions> requestOptionsMap = new ConcurrentHashMap();
    ...
    public Result productLaunchDetailsByOutRequestNo(@PathVariable(value = "out_request_no") String out_request_no) throws EntpayException {
        try {
    ...
    public Result productLaunchDetailsByRequestNo(@PathVariable(value = "request_no") String request_no) throws EntpayException {
        try {
            ProductApplication application = new ProductApplication();
    ...
    public Result getSoftCertificate(@PathVariable(value = "ent_id") String ent_id) throws EntpayException {
        try {
