...
public class Notification {
    ...
    public WebhookResult productApplicationOpenNotify(HttpServletRequest request,@RequestBody String body,@RequestHeader("TBEP-Authorization") String auth) throws EntpayException, JsonProcessingException {
        try {
