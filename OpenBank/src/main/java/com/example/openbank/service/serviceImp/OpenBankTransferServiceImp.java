...
public class OpenBankTransferServiceImp implements OpenBankTransferService {
    ...
    //构造唯一OutTransferTd使用
    public static ConcurrentHashMap<String,Integer> getOutTransferTd = new ConcurrentHashMap<>();
    ...
    public String createOutTransferTd(){
        ...
        int oid = out_transfer_id+1;
        getOutTransferTd.put("out_transfer_id",oid);
        return String.valueOf(System.currentTimeMillis()+getOutTransferTd.get("out_transfer_id"));
    }
